...
const itemSpritesheetSrc = "/losthq/img/item_spritesheet.png";
let itemBitmap = null;
...
const npcSpritesheetSrc = "/losthq/img/npc_spritesheet.png";
let npcBitmap = null;
...
(async () => {
    try {
        ...
        const [itemJson, npcJson, sharedDropTablesData] = await Promise.all([
            fetch(`/losthq/js/itemdb/item_data.json?v=${currentGameVer}`).then((res) => res.json()),
            fetch(`/losthq/js/npcdb/npc_data.json?v=${currentGameVer}`).then((res) => res.json()),
            fetch(`/losthq/js/npcdb/shared_drops.json?v=${currentGameVer}`).then((res) => res.json())
        ]);
